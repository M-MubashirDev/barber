...
function Duration({ data, Clicking }) {
  ...
  return (
    <button
      ...
      style={{ "--price": `"$${price}"` }}
      className={`border-[0.5px] rounded-[20px] flex relative w-full h-48 border-[#4F4F4F] shadow-brown-primary hover:shadow-[1px_1px_10px_-2px_#0000007d] transition-shadow 
