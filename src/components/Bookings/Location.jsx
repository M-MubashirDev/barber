    ...
    >
      <div className="max-w-full mx-auto mt-[5%] flex flex-col items-center lg:items-start w-[90%]">
        ...
        <button
          ...
          className="relative font-semibold uppercase md:text-[28px] text-[20px] sm:text-[22px] lg:text-[32px] max-w-fit p-6 mb-4 md:py-6 md:px-28 bg-brown-primary leading-[37.5px] rounded-[20px] text-white overflow-hidden group hover-white hover-styling"
        >
          {/* Expanding Background Effect */}
          <span className="absolute top-1/2 left-1/2 w-0 h-0 transition-all duration-700 ease-out bg-white rounded-full group-hover:w-[300%] group-hover:h-[300%] transform -translate-x-1/2 -translate-y-1/2"></span>
          {/* Text Content */}
