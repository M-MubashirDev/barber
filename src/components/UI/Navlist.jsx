    ...
    <>
      ...
      <li onClick={() => (setIsOpen ? setIsOpen(false) : "")}>
        <button
          ...
          className="relative font-montserrat  inline-flex items-center justify-center rounded-[10px]  overflow-hidden  tracking-tighter  group border sm:place-self-center lg:place-self-start   border-brown-primary text-[14px] sm:text-[16px] w-72 h-11 bg-white text-brown-primary hover:bg-[#4b2e2e] hover:shadow-lg shadow-brown-primary hover:text-white hover-styling"
        >
